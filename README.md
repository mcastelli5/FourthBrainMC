...
# <h1 align="center" id="heading">:wave: Welcome to MLE Cohort 7 (April 2022)!</h1>

Welcome to MLE! :tada: Follow these steps to get your development environment teed up and aligned to the rest of the class.  This will ensure that we can hit the ground running this Saturday! :running:
